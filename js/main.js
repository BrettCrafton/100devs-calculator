...
resetButton.addEventListener('click', clearOperations)
const lastEntryResetButton = document.querySelector('.lastEntryReset')
lastEntryResetButton.addEventListener('click', lastEntryClear)
...
function addToArray(click){ 
  ...
  //computations after the first occurs i.e. equals sign is hit multiple times or addtional operation added
    ...
    alert("Do you really need more than 9 digits in a simple calculator?\n\n(Limited as to not break diplay.)")
  }
}
